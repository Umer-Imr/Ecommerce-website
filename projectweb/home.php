 ...
 <?php
   ...
   ?>
    ...
    <div class="carousel-item ">
      <img src="imege/log1.jpg" height="50%" width="auto" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="imege/log2.png" height="50%" width="auto" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item active">
      <img src="imege/log3.webp" height="50%" width="auto" class="d-block w-100" alt="...">
    </div>
    </div>
